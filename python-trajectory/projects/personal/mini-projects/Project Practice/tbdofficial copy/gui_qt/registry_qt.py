# Author:      Miguel Gonzalez Almonte  # Created:     2025-05-24  # File:        registry_qt.py  # Description: Loads and registers Qt demos  
# registry_qt.py
# Dynamically loads demo_* modules from gui_qt/demos/
